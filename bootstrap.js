...
function main() {
  ...
  var name = args[0];
  if (name) {
      replaceStringInFile('./app/src/main/java/yourcompany/starter_android/MainActivity.java', /<YOUR-FIREBASE-APP>/g, name);
  }
}
...
function main(RSVP, name, dest) {
  ...
  function renameToFirebaseApp() {
    ...
    return RSVP.all(['./app/src/main/java/yourcompany/starter_android/MainActivity.java'].map(function (file) {
